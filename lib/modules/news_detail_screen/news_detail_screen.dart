    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              "https://i.postimg.cc/jS7Bx19w/gambar2.jpg",
            ),
            Padding(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Snowdrop menceritakan kisah tentang seorang mata-mata Korea Utara yang menyamar sebagai mahasiswa keturunan Jerman.',
                    maxLines: 10,
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Image.network(
              "https://i.postimg.cc/XJt8h1v4/gambar1.jpg",
            ),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 24),
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  const Text(
                    'Drama korea yang sedang tranding',
                    maxLines: 10,
                    textAlign: TextAlign.justify,
                    overflow: TextOverflow.ellipsis,
                  )
